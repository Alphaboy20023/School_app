...
from .models import ( CustomUser, Student, Payment,
    Receipt, IdentityCard, Result, Course, 
    Announcement, Post, Repost, 
    Comment, Lecture, Question, Exam, LecturerProfile,
    Notification, Department, Course, AcademicSession, Calendar, TimeTable
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Student
        fields= ['user', 'age', 'current_session', 'department','admission_number','date_of_birth', 'Faculty','student_picture']
